			...
			<div class="form-w3ls p-md-10 p-4">
				...
				<form action="#" id="form-data-member" method="POST" enctype="multipart/form-data">
					...
					<div class="input-group1 text-right">
						<button class="btn btn-primary" name="simpan" onclick="storeData()" type="submit"
...
<!-- Modal -->
<div class="modal fade" id="show-lampiran" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
	aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body render-lampiran">
				<embed width="100%" height="500px" src="<?=base_url();?>/uploads/b9d1060d4d13a2deaa1f940f542dcaf4.pdf"
					type="">
			</div>
...
<!-- Modal -->
<div class="modal fade" id="upload-dokument" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
	aria-hidden="true">
			...
			<form action="#" id="form-upload-dokument" enctype="multipart/form-data" method="post">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="file" name="lampiran" id="lampiran" class="form-control" placeholder=""
							aria-describedby="helpId">
						<small id="helpId" class="text-error e-lampiran">Lampiran yang di izinkan hanya berupa
