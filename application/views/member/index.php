					...
					<div class="col-xl-6 col-lg-5 top-social-w3pvt-am mt-lg-1 mb-md-0 mb-1 text-lg-left text-center">
						<div class="row">
							...
							<div class="col-xl-8 col-10 header-top_w3layouts text-md-right">
								<p class="text-bl">
									<span style="font-family:Times New Roman">Selamat Datang pada PSB Online SMP PNIEL MEDAN: <?=$this->session->userdata('nama')?></span>
								</p>
							</div>
			...
			<div class="nav_w3ls mx-lg-auto">
				<nav>
					...
					<ul class="menu mx-lg-auto">
						...
						<li><a href="<?=base_url('member/tampail_data/' . $this->session->userdata('id_user'))?>" class="fa fa-user">Profil</a></li>
						<li><a href="<?=base_url('member/tampail_data/' . $this->session->userdata('id_user'))?>" class="fa fa-bullhorn">Pengumuman</a></li>
